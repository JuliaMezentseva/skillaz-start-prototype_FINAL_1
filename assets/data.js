...
window.SITE_DATA = {
  ...
  plans: {
    onboarding: {
      ...
      // Маршрут — эталонная методическая структура: этапы названы по фазе адаптации
      // (что происходит с человеком), а срок вынесен в dueLabel, чтобы заголовок не
      // превращался в дату. Знакомство → подготовка → погружение: первые три этапа
      // последовательны и с дедлайном, четвёртый — открытая библиотека без срока,
      // куда сотрудник заходит сам (материалы больше не привязаны к шагам целей).
      stages: [
        {
          id: "s1",
          ...
          items: [
            ...
            { id: "e14c", kind: "task", title: "Познакомиться с командой на еженедельной летучке", date: "2 марта", done: true },
            { id: "e5", kind: "article", title: "Ценности и культура Skillaz: как мы работаем и принимаем решения", date: "2 марта", duration: "10 м.", done: true },
            { id: "e7", kind: "article", title: "Правила компании: трудовой распорядок и кодекс деловой этики", date: "3 марта", duration: "12 м.", done: true },
            { id: "e13", kind: "article", title: "Что компания даёт сотруднику: ДМС, компенсации, отпуска", date: "3 марта", duration: "10 м.", done: true },
          ],
        },
        {
          id: "s2",
          ...
          status: "in_progress",
          dueLabel: "До 1 недели",
          items: [
            { id: "e10", kind: "task", title: "Настроить рабочее место: почта, календарь, корпоративный мессенджер", date: "4 марта", done: true },
            ...
            { id: "e11", kind: "task", title: "Получить доступ к базе знаний и справочникам по продукту", date: "до 6 марта", done: false },
            { id: "e12b", kind: "task", title: "Подключить двухфакторную аутентификацию для рабочих систем", date: "до 6 марта", done: false },
            { id: "e6", kind: "course", title: "Пройти вводный инструктаж по охране труда и технике безопасности", date: "до 7 марта", done: false },
            { id: "e9", kind: "task", title: "Пройти тест на знание регламента ИБ", date: "до 7 марта", duration: "15 м.", done: false, highlight: "warning" },
            { id: "e14", kind: "task", title: "Оформить заявление на ДМС", date: "до 7 марта", done: false },
            { id: "e12c", kind: "article", title: "Оргструктура: к кому обращаться по рабочим вопросам", date: "до 7 марта", duration: "6 м.", done: false },
          ],
        },
        {
          id: "s3",
          ...
          items: [
            ...
            { id: "e3", kind: "article", title: "Изучить продуктовую линейку и конкурентное позиционирование", date: "до 22 марта", duration: "50 м.", done: false },
            { id: "e17", kind: "article", title: "Регламент оформления сделки в CRM", date: "до 25 марта", duration: "10 м.", done: false },
            { id: "e18", kind: "article", title: "Стандарты общения с клиентом", date: "до 28 марта", duration: "10 м.", done: false },
            { id: "e4b", kind: "link", title: "Шаблон коммерческого предложения компании", date: "до 31 марта", done: false, url: "#",
        ...
        },
        {
          ...
          status: "locked",
          dueLabel: "До конца адаптации",
          items: [
            { id: "e19", kind: "course", title: "Курс по работе с возражениями", date: "", done: false },
            { id: "e21", kind: "article", title: "Сложные переговоры: как торговаться и удерживать цену", date: "", duration: "20 м.", done: false },
      ...
      goals: [
        {
          ...
          subgoals: [
            { id: "g1s1", title: "Проводить первичную квалификацию лида по чек-листу BANT/SPICED", dueLabel: "до 6 мар", status: "done", reviewer: "Анна Козлова",
              ...
              assessmentChecklist: {
                title: "Оценочный лист: квалификация лида",
                ...
                criteria: [
                  ...
                  { id: "c4", label: "Корректно заполнил карточку лида в CRM" },
                ],
              },
              assessmentHistory: [
                { date: "3 мар, 15:20", reviewer: "Анна Козлова", decision: "returned",
                  criteria: [
                    ...
                    { id: "c4", label: "Корректно заполнил карточку лида в CRM", checked: false },
                  ],
                  note: "Бюджет и заполнение карточки — мимо. Пройди ещё пару лидов и обрати внимание на эти пункты." },
                { date: "5 мар, 09:40", reviewer: "Анна Козлова", decision: "done",
                  criteria: [
                    { id: "c1", label: "Задал вопросы по бюджету (Budget) и зафиксировал ответ", checked: true },
                    { id: "c2", label: "Выявил лицо, принимающее решение (Authority)", checked: true },
                    { id: "c3", label: "Уточнил потребность и сроки (Need/Timing)", checked: true },
                    { id: "c4", label: "Корректно заполнил карточку лида в CRM", checked: true },
                  ],
          ...
          subgoals: [
            { id: "g3s1", title: "Самостоятельно провести сделку от первого контакта до закрытия", dueLabel: "до 4 май", status: "not_started", reviewer: "Анна Козлова",
              ...
              assessmentChecklist: {
                ...
                criteria: [
                  { id: "c1", label: "Провёл квалификацию лида по чек-листу" },
  ...
  vacancies: [
    {
      ...
      matchingEmployees: [
        { name: "Артём Ковалёв", position: "Специалист контакт-центра", department: "Контактный центр", matchPercent: 91, email: "a.kovalev@skillaz.com",
          grade: "Junior", tenure: "2 года 3 месяца", score360: 4.7, iprProgress: 60, iprGoal: "Развитие в поддержке клиентов", missingSkills: [],
        ...
        { name: "Дарья Фомина", position: "Оператор поддержки", department: "Контактный центр", matchPercent: 84, email: "d.fomina@skillaz.com",
          grade: "Junior", tenure: "1 год 6 месяцев", score360: 4.3, iprProgress: 40, iprGoal: "Освоение сложных обращений", missingSkills: ["Работа с возражениями"],
        ...
        { name: "Максим Орлов", position: "Специалист контакт-центра", department: "Контактный центр", source: "reserve", targetRole: "Специалист поддержки клиентов", matchPercent: 82, email: "m.orlov@skillaz.com",
          grade: "Junior", tenure: "1 год 8 месяцев", score360: 4.5, iprProgress: 70, iprGoal: "Подготовка к переходу в поддержку", missingSkills: ["Работа с возражениями"],
        ...
        { name: "Светлана Дорохова", position: "Оператор поддержки", department: "Контактный центр", source: "reserve", matchPercent: 70, email: "s.dorokhova@skillaz.com",
          grade: "Junior", tenure: "10 месяцев", score360: 4.1, iprProgress: 30, iprGoal: "Развитие клиентского сервиса", missingSkills: ["CRM", "Работа с возражениями"],
    ...
    },
    {
      ...
      matchingEmployees: [
        { name: "Юлия Мезенцева", position: "Менеджер по продажам", department: "Департамент продаж", matchPercent: 88, email: "y.mezentseva@skillaz.com",
          grade: "Middle", tenure: "5 месяцев", score360: 4.4, iprProgress: 50, iprGoal: "Стать руководителем команды", missingSkills: ["Управление командой", "Переговоры"],
        ...
        { name: "Роман Дьяконов", position: "Ведущий менеджер по продажам", department: "Департамент продаж", matchPercent: 79, email: "r.dyakonov@skillaz.com",
          grade: "Middle+", tenure: "3 года", score360: 4.2, iprProgress: 65, iprGoal: "Развитие переговорных навыков", missingSkills: ["Переговоры"],
        ...
        { name: "Кирилл Назаров", position: "Ведущий менеджер по продажам", department: "Департамент продаж", source: "reserve", targetRole: "Руководитель отдела продаж", email: "k.nazarov@skillaz.com",
          grade: "Middle+", tenure: "3 года 4 месяца", score360: 4.8, iprProgress: 90, iprGoal: "Подготовка к позиции руководителя отдела продаж", missingSkills: ["Воронка продаж"],
        ...
        { name: "Анна Гришина", position: "Менеджер по продажам", department: "Департамент продаж", source: "reserve", email: "a.grishina@skillaz.com",
          grade: "Middle", tenure: "2 года", score360: 4.6, iprProgress: 55, iprGoal: "Развитие лидерского потенциала", missingSkills: ["Управление командой", "Воронка продаж"],
    ...
    },
    {
      ...
      matchingEmployees: [
        { name: "Виктория Панкратова", position: "Руководитель проектов", department: "Дирекция по развитию", source: "reserve", targetRole: "Руководитель проектного офиса", email: "v.pankratova@skillaz.com",
          grade: "Middle+", tenure: "2 года 4 месяца", score360: 4.7, iprProgress: 75, iprGoal: "Подготовка к позиции руководителя проектного офиса", missingSkills: ["Бюджетирование"],
  ...
  managerActions: [
    ...
    { id: "a3", type: "subgoal", title: "Подтвердить подцель «Провести первую консультацию покупателя под наблюдением наставника»", employeeId: "alexey", employee: "Алексей Ковалев", doneAt: "18 янв 26, 16:15", doneBucket: "other" },
    ...
    goals: [
      {
        ...
        subgoals: [
          ...
          { id: "alg1s3", title: "Изучить ассортимент и основные группы товаров", dueLabel: "до 20 янв", status: "pending_review", reviewer: "Анна Козлова",
            comments: [
              { author: "Алексей Ковалев", date: "19 янв, 09:40", text: "Изучил ассортимент по каталогу и прошёл тест в приложении — готов к проверке." },
            ],
            assessmentChecklist: {
      ...
      },
      {
        ...
        subgoals: [
          ...
          { id: "alg2s1", title: "Оформить первую самостоятельную продажу", dueLabel: "до 25 янв", status: "pending_review", reviewer: "Анна Козлова",
            description: "Самостоятельно провести покупателя от консультации до оформления покупки на кассе, без участия наставника.",
            comments: [
              { author: "Алексей Ковалев", date: "20 янв, 17:45", text: "Оформил первую продажу самостоятельно — кроссовки и уход за обувью, чек приложил. Готово к проверке." },
            ] },
        ],
      },
    ],
  ...
  window.SITE_DATA.templates = [
    {
      ...
      name: "Шаблон для резервистов: Директор магазина",
      description: "Подготовка резервиста к позиции директора магазина: операционное управление, команда, показатели. Без базового знакомства с компанией — резервист уже работает в сети.",
      status: "active",
      planType: "Внутренний переход",
      durationDays: 45,
      category: "Адаптация",
      department: "Дирекция по рознице",
      function: "Менеджмент",
      company: "ООО «Скиллаз»",
      ...
      goals: [
        {
          id: "rsdgoal1",
          title: "Пройти операционный аудит магазина с результатом не ниже 90%",
          description: "Разобраться в ключевых процессах магазина: смены, товарный запас, соответствие стандартам сети.",
          dueDays: 20,
          subgoals: [
            { id: "rsdsg1", title: "Пройти аудит магазина по чек-листу операционных стандартов вместе с наставником", description: "", dueDays: 10, reviewer: "Руководитель" },
            { id: "rsdsg2", title: "Устранить 100% критичных замечаний по итогам аудита", description: "", dueDays: 15, reviewer: "Руководитель" },
            { id: "rsdsg3", title: "Составить и защитить график смен на 4 недели вперёд", description: "", dueDays: 20, reviewer: "Руководитель" },
          ],
        },
        {
          id: "rsdgoal2",
          title: "Укомплектовать команду и провести оценку 100% смены",
          description: "Научиться формировать, обучать и мотивировать команду магазина.",
          dueDays: 35,
          subgoals: [
            { id: "rsdsg4", title: "Провести собеседования на 2 открытые позиции в команде", description: "", dueDays: 25, reviewer: "Руководитель" },
            { id: "rsdsg5", title: "Провести оценку эффективности для 100% сотрудников смены", description: "", dueDays: 30, reviewer: "Руководитель" },
            { id: "rsdsg6", title: "Разработать план развития для 1 сотрудника", description: "", dueDays: 35, reviewer: "Руководитель" },
          ],
        },
      ],
      ...
      checkpoints: [],
      participants: [
        { id: "p1", kind: "system", roleId: "manager", required: true, isPrimary: true, demoPerson: { name: "Сергей Орлов", position: "Директор по рознице" } },
        { id: "p2", kind: "system", roleId: "hrbp", required: true, isPrimary: false, demoPerson: { name: "Юлия Степанова", position: "HR BP" } },
        { id: "p3", kind: "business", roleId: "mentor", required: true, demoPerson: { name: "Ирина Волкова", position: "Директор магазина" } },
  ...
  window.SITE_DATA.vacancies.forEach((v) => {
    ...
    for (let i = 0; i < v.responsesCount; i++) {
      ...
      v.responses.push({
        ...
        email: "candidate" + (i + 1) + "." + v.id + "@skillaz.com",
