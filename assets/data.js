  ...
  window.SITE_DATA.templates = [
    {
      ...
      goals: [
        ...
        {
          id: "rsdgoal3",
          title: "Выполнить план по выручке на 100% и удержать NPS не ниже 8",
          description: "Продемонстрировать способность самостоятельно управлять выручкой, маржой и клиентским опытом магазина.",
          dueDays: 45,
          subgoals: [
            { id: "rsdsg7", title: "Подготовить и защитить план по выручке и марже на квартал с ростом не менее 10%", description: "", dueDays: 40, reviewer: "Руководитель" },
            { id: "rsdsg8", title: "Обеспечить показатель NPS не ниже 8 по итогам месяца", description: "", dueDays: 45, reviewer: "Руководитель" },
          ],
        },
      ],
